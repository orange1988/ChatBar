...
import com.orange.chatbar.utils.PathUtil;
...
public class OrangeVoiceRecorder {
    ...
    public OrangeVoiceRecorder(Handler handler) {
    ...
    public String startRecording(Context appContext) {
        ...
        try {
            ...
            //TODO 此处应该传入用户名
            voiceFileName = getVoiceFileName("Orange");
        ...
        Timber.d("start voice recording to file:" + file.getAbsolutePath());
    ...
    public int stopRecoding() {
        if (recorder != null) {
            ...
            if (file == null || !file.exists() || !file.isFile()) {
                return OrangeError.INVALID_FILE;
            }
            if (file.length() == 0) {
                file.delete();
                return OrangeError.INVALID_FILE;
            ...
            Timber.d("voice recording finished. seconds:" + seconds + " file length:" + file.length());
            return seconds;
        }
        return 0;
    }
