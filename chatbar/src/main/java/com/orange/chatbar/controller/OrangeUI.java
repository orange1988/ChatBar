package com.orange.chatbar.controller;
...
public final class OrangeUI {
	private static final String TAG = OrangeUI.class.getSimpleName();

	/**
	 * the global OrangeUI instance
	 */
	private static OrangeUI instance = null;
	 ...
	 * @return
	 */
	public synchronized static OrangeUI getInstance() {
		if (instance == null) {
			instance = new OrangeUI();
		}
		return instance;
	}
