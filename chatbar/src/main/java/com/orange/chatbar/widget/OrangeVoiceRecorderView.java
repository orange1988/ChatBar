...
import com.orange.chatbar.OrangeError;
import com.orange.chatbar.R;
import com.orange.chatbar.entity.OrangeVoiceRecorder;
import com.orange.chatbar.utils.CommonUtils;
 ...
 *
 */
public class OrangeVoiceRecorderView extends RelativeLayout {
    protected Context context;
    protected LayoutInflater inflater;
    protected Drawable[] micImages;
    protected OrangeVoiceRecorder voiceRecorder;
    ...
    public OrangeVoiceRecorderView(Context context) {
        super(context);
        init(context);
    }

    public OrangeVoiceRecorderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OrangeVoiceRecorderView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        voiceRecorder = new OrangeVoiceRecorder(micImageHandler);
    ...
    public boolean onPressToSpeakBtnTouch(View v, MotionEvent event, EaseVoiceRecorderCallback recorderCallback) {
        ...
        case MotionEvent.ACTION_DOWN:
            try {
                //TODO 要判断是否正在播放录音,如果播放录音，则要停止播放。
                v.setPressed(true);
                startRecording();
            } catch (Exception e) {
                v.setPressed(false);
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (event.getY() < 0) {
                ...
                try {
                    ...
                    } else if (length == OrangeError.INVALID_FILE) {
