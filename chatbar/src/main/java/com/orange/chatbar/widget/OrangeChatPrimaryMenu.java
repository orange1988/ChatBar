 ...
 *
 */
public class OrangeChatPrimaryMenu extends OrangeChatPrimaryMenuBase implements OnClickListener {
    ...
    private OrangeVoiceRecorderView voiceRecorderView;

    public OrangeChatPrimaryMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public OrangeChatPrimaryMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OrangeChatPrimaryMenu(Context context) {
        super(context);
        init(context, null);
    }
     ...
     */
    public void setPressToSpeakRecorderView(OrangeVoiceRecorderView voiceRecorderView){
