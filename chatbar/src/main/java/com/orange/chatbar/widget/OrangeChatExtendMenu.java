...
import com.orange.chatbar.utils.DensityUtil;
 ...
 *
 */
public class OrangeChatExtendMenu extends GridView{

    protected Context context;
    private List<ChatMenuItemModel> itemModels = new ArrayList<ChatMenuItemModel>();

    public OrangeChatExtendMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public OrangeChatExtendMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public OrangeChatExtendMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.OrangeChatExtendMenu);
        int numColumns = ta.getInt(R.styleable.OrangeChatExtendMenu_numColumns, 4);
        ta.recycle();
