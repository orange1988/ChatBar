package com.orange.chatbar.widget;
...
public class OrangeChatInputMenu extends LinearLayout {
    ...
    public OrangeChatInputMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public OrangeChatInputMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public OrangeChatInputMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        chatExtendMenuContainer = (FrameLayout) findViewById(R.id.extend_menu_container);
         ...
         // 扩展按钮栏
         chatExtendMenu = (OrangeChatExtendMenu) findViewById(R.id.extend_menu);
    ...
    public void init(List<OrangeEmojGroupEntity> emojiconGroupList) {
        ...
        if(chatPrimaryMenu == null){
            chatPrimaryMenu = (OrangeChatPrimaryMenu) layoutInflater.inflate(R.layout.ease_layout_chat_primary_menu, null);
        }
     ...
     */
    public void setCustomPrimaryMenu(OrangeChatPrimaryMenuBase customPrimaryMenu){
        this.chatPrimaryMenu = customPrimaryMenu;
    }
    
    public OrangeChatPrimaryMenuBase getPrimaryMenu(){
        return chatPrimaryMenu;
    }
    
    public OrangeChatExtendMenu getExtendMenu(){
    ...
    public void registerExtendMenuItem(String name, int drawableRes, int itemId,
                                       OrangeChatExtendMenu.EaseChatExtendMenuItemClickListener listener) {
    ...
    protected void processChatMenu() {
        // 发送消息栏
        chatPrimaryMenu.setChatPrimaryMenuListener(new OrangeChatPrimaryMenuBase.EaseChatPrimaryMenuListener() {
